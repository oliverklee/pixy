...
public class FunctionModels {
	...
	public FunctionModels(Set<String> f_evil, Map<String, Set<Integer>> f_multi, Map<String, Set<Integer>> f_invMulti,
			Set<String> f_strongSanit, Map<String, Set<Integer>> f_weakSanit) {
